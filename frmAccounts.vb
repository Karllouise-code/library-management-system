...
Public Class frmAccounts
    ...
    Private Sub LoadTables(Optional ByVal q As String = "")
        Try
            ...
            query.CommandText = "SELECT * FROM tblUsers"
    ...
    Private Sub btnVerify_Click(sender As Object, e As EventArgs) Handles btnVerify.Click
        Try
            ...
            query.CommandText = "UPDATE tblUsers SET Verified = '" & txtStatus.Text & "' WHERE User_ID = " & txtUserid.Text & ""
    ...
    Private Sub btnModify_Click(sender As Object, e As EventArgs) Handles btnModify.Click
        Try
            ...
            ElseIf btnModify.Text = "Confirm" Then
                ...
                query.CommandText = "UPDATE tblUsers SET [Fullname] = '" & txtFullname.Text & "', [Username] = '" & txtUsername.Text & "', [Contact_Number] = '" & txtContactNo.Text & "', [Password] = '" & txtPassword.Text & "', [Date_Created] = '" & Today & "' WHERE User_ID = " & txtUserid.Text & ""
                query.ExecuteNonQuery()
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            If con.State = ConnectionState.Closed Then
                OpenCon()
            End If
            query.CommandText = "DELETE * FROM tblUsers WHERE User_ID = " & txtUserid.Text & ""
            query.ExecuteNonQuery()
